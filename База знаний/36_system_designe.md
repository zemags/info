...
#### мастер - работник репликация (масштабирование)
 - мастер читает и пишет
 - реплецирует на одного и более работников, работники только читают
 - если мастер упал, то система только в чтение
 - можно поднять работника до мастера
...
- недостатки:
 ...
 - чем больше работников чтения, тем больше задержка репликации
